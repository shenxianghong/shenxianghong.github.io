...
2. 过滤掉 hostPath 类型的卷，对其余的合法卷会创建对应的 PodVolumeBackup 对象，其中 PodVolumeBackup 中会设置 velero.io/backup-name 标签以及 PVC 的 UID 信息<br>*此时，该对象的 spec.RepoIdentifier 已被设置，例如 s3:http://minio.velero.svc:9000/velero/restic/velero*
