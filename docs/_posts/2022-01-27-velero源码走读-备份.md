...
5. 针对类型是 Pod 的 item，在 spec.Volumes 中过滤出需要借助 Restic 备份的卷<br>*由于 PV 和 PVC 是 1 对 1，PVC 和 Pod 是 1 对 n 的关系，所以在这里通过跟踪 PVC 的备份情况即可判断卷是否被备份过*
